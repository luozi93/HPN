...
d),c.commands.autotypeset={execCommand:function(){c.removeListener("beforepaste",d);b.pasteFilter&&c.addListener("beforepaste",d);d.call(c)}})};UE.plugins.autosubmit=function(){this.commands.autosubmit={execCommand:function(){var f=e.findParentByTagName(this.iframe,"form",!1);f&&!1!==this.fireEvent("beforesubmit")&&(this.donc(),f.submit())}};this.addshortcutkey({autosubmit:"ctrl+13"})};UE.plugins.background=function(){var f=this;f.addListener("getAllHtml",function(a,d){var c=this.body,b=e.getComputedStyle(c,
